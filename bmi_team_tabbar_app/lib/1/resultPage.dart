...
import 'package:bmi_team_tabbar_app/1/message1.dart';
...
class _ResultPageState extends State<ResultPage> {
  // Property
  double height = double.parse(Message1.height)/100;
  double weight = double.parse(Message1.weight);
  double bmi_result = 0;
  String bmi = "";
  String advice = "";
